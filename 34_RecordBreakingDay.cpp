...
int main(){
    ...
    int arr[n+1];//array of size n+1 is declared as we have to compare n+1th elemet also
    arr[n]=-1;//initializing nth element to -1 so that following condition always satisfies
    for(int i=0;i<n;i++){
        cin>>arr[i];
    }
